...
function BasicButton(options, ui, drawingTool) {
  ...
  var title = $('<div/>').html(options.tooltip).text();
...
TextTool.prototype.editText = function (text, e) {
  ...
  if (text.hiddenTextarea && text.canvas) {
    ...
    if (fabric.isTouchSupported) {
      ...
      $(text.hiddenTextarea).css({left: '0px', top: e.pageY || 0, 'font-size': '50px'});
    }
...
function generateStamps(uiDefinition, stampsDefition) {
  ...
  // Main stamp button.
  var prevBtnIdx = 3; // findButtonIndex(INSERT_STAMP_AFTER, uiDefinition.buttons);
  uiDefinition.buttons.splice(prevBtnIdx + 1, 0, {
    name: 'stamp',
    tooltip: js_translation["tooltip_stamp"],
    classes: 'dt-expand',
    label: 'M',
    palette: 'main',
    activatesTool: 'stamp',
    onClick: function () {
      ...
      this.ui.togglePalette('_StampsPalette');
    }
  });
  ...
  Object.keys(stampsDefition).forEach(function (category) {
    ...
    var categoryBtn = {
      ...
      label: category,
      tooltip: js_translation["tooltip_stampcategory"],
...
var ui = {
  ...
  buttons: [
    ...
    {
      label: 's',
      tooltip: js_translation["tooltip_select"],
      activatesTool: 'select',
      palette: 'main'
    },
    {
      name: 'linesPalette',
      tooltip: js_translation["tooltip_linetool"],
      classes: 'dt-expand',
    ...
    {
      name: 'shapesPalette',
      tooltip: js_translation["tooltip_shapes"],
      classes: 'dt-expand',
...
*/
    {
      name: 'text',
      tooltip: js_translation["tooltip_text"],
      label: 'T',
    ...
    */
    {
      ...
      tooltip: js_translation["tooltip_stroke"],
    ...
    },
    {
      ...
      tooltip: js_translation["tooltip_fill"],
...
/*
    ...
    {
      name: 'trash',
      tooltip: js_translation["tooltip_trash"],
      label: 'd',
      activatesTool: 'trash',
      palette: 'main',
      onInit: lockWhenNothingIsSelected
    ...
    {
      name: 'line',
      tooltip: js_translation["tooltip_line"],
      label: 'L',
      activatesTool: 'line',
      palette: 'lines'
    },
    ...
    {
      name: 'doubleArrow',
      tooltip: js_translation["tooltip_doubleArrow"],
      label: 'D',
    ...
    {
      name: 'rect',
      tooltip: js_translation["tooltip_rectangle"],
      label: 'R',
      activatesTool: 'rect',
      palette: 'shapes'
    },
    {
      name: 'ellipse',
      tooltip: js_translation["tooltip_ellipse"],
      label: 'E',
    ...
    {
      name: 'square',
      tooltip: js_translation["tooltip_square"],
      label: 'S',
    ...
    {
      name: 'circle',
      tooltip: js_translation["tooltip_circle"],
      label: 'C',
